...
ALTER TABLE `repairs`
  ...
  ADD COLUMN IF NOT EXISTS `company_name` VARCHAR(200) NULL DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `created_at` DATETIME NULL DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `created_by` INT(11) NULL DEFAULT NULL;

CREATE TABLE IF NOT EXISTS `following_up` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`repair_id` INT(11) NULL DEFAULT NULL,
	`target_mileage` INT(11) NULL DEFAULT NULL,
	`created_at` DATETIME NULL DEFAULT NULL,
	`created_by` INT(11) NULL DEFAULT NULL,
	PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

ALTER TABLE `following_up`
  ADD COLUMN IF NOT EXISTS `repair_id` INT(11) NULL DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `target_mileage` INT(11) NULL DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `created_at` DATETIME NULL DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `created_by` INT(11) NULL DEFAULT NULL;
