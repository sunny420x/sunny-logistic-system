...
function getMyRoutes(driver_id) {
    return new Promise(resolve => {
        ...
        r.driver_id, t.id as truck_id, r.weight, r.finish_at, r.arrivalImage,  r.location_note, r.driver_note, r.temporary_location, r.arrival_at_warehouse, r.round, r.created_at 
        FROM transition_records as r 
        JOIN customers as c ON c.id = r.customer_id 
        LEFT JOIN trucks as t ON t.id = r.truck_id
